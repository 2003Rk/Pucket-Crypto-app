...
import 'package:cryptoapp/wallet/topupaccountpage.dart';
import 'package:flutter/material.dart';

class ChooseWallet2 extends StatefulWidget {
  const ChooseWallet2({Key? key}) : super(key: key);

  @override
  State<ChooseWallet2> createState() => _ChooseWallet2State();
}

class _ChooseWallet2State extends State<ChooseWallet2> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildBankCard(
                      ...
                      accountNumber: '**** **** **** 1121',
                      icon: _buildCountryIcon('assets/nigeria.png', screenWidth),
                    ...
                    _buildBankCard(
                      ...
                      accountNumber: '**** **** **** 1564',
                      icon: _buildCountryIcon('assets/canada.png', screenWidth),
  ...
  Widget _buildCountryIcon(String assetPath, double screenWidth) {
    return Container(
